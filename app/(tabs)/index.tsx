    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
      <View style={styles.heroPanel}>
        ...
        <Text style={styles.heroDescription}>
          Semua data tetap di device. Mulai dari routine agar flow workout siap di stage berikutnya.
        </Text>
        <PrimaryButton
          label={recentRoutines.length > 0 ? "View Routines" : "Create First Routine"}
          onPress={() => {
